...
namespace media::api {
    ...
    void HttpServer::run_internal() {
        try {
            ...
            docInfo->description = "C++20 BitTorrent Server";
            docInfo->version = "2.0";
            
            // We must load the UI resources
            ...
            auto swaggerController = oatpp::swagger::Controller::createShared(router->getEndpoints(), docInfo, resources);
