...
namespace media::services {
    ...
    std::vector<DiscoveredContent> EZTVClient::fetchPopular(int limit, int /*page*/, const std::string& genre, const std::string& language) {
    ...
    // Search Series
    std::vector<DiscoveredContent> EZTVClient::search(const std::string& query, int limit, int /*page*/, const std::string& genre, const std::string& language) {
