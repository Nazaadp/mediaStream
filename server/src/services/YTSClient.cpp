...
namespace media::services {
    ...
    std::vector<DiscoveredContent> YTSClient::fetchPopular(int limit, int page) {
    ...
    // Search Movies
    std::vector<DiscoveredContent> YTSClient::search(const std::string& query, int limit, int page) {
